...
[0] = { /* Qwerty */
  ...
  {M(0), KC_LCTL, KC_LALT, KC_LGUI, M(3),    KC_SPC,   KC_SPC,    M(2),   KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT}
...
[1] = { /* Colemak */
  ...
  {KC_TRNS, KC_LCTL, KC_LALT, KC_LGUI, M(3),    KC_SPC,   KC_SPC,    M(2),   KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT}
},
[2] = { /* RAISE */
  {KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC},
  {KC_TRNS, FUNC(3), FUNC(4), RESET,   UC(0x1F601),    UC(0x1F618), KC_TRNS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
...
[3] = { /* LOWER */
  ...
  {KC_TRNS, FUNC(3), FUNC(4), RESET,   UC(0x1F601),  UC(0x1F618), KC_TRNS, S(KC_MINS), S(KC_EQL),  S(KC_LBRC), S(KC_RBRC), S(KC_BSLS)},
